...
public class PlaceOrderServiceTests {
    ...
    void itShouldCreateOrderWithoutAnyPromotion() {
        ...
        CartProduct cartProduct1 = TestsUtils.cartProductOf(1L, cart, product1, 1);
        CartProduct cartProduct2 = TestsUtils.cartProductOf(2L, cart, product2, 3);
        CartProduct cartProduct3 = TestsUtils.cartProductOf(3L, cart, product3, 1);
        ...
        // when
        OrderResponseDto result = underTest.createOrder(orderRequestDto);
